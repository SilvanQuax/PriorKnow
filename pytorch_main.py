...
for ii in xrange(1,6):
    ...
    param_loc = '/vol/ccnlab1/silqua/prirep/models/pytorch/param_NH200_det_new_rev' + task
    model_loc = '/vol/ccnlab1/silqua/prirep/models/pytorch/model_NH200_det_new_rev' + task
    ...
    # params['sig_phi']=10.0
    # params['sigmas'] = [25.0, 25.0]
    params['sigmas'] = [0.0, 0.0]
    params['sig_phi'] = 10.0
    # params['gain']=(np.array([0.37,0.90,1.81,2.82,3.57,4.00])*0.8).tolist()#[0.37,0.90,1.81,2.82,3.57,4.00]*0.4 #*0.4
    #params['gain']=(100*np.linspace(0.5,4.0,6)).tolist()#[0.37,0.90,1.81,2.82,3.57,4.00]*0.4 #*0.4
    params['gain']=(np.linspace(10.0,10.01,6).T).tolist()#[0.37,0.90,1.81,2.82,3.57,4.00]*0.4 #*0.4
